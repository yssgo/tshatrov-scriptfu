...
;; Sensu Iun: You can find original export-layers-plus.scm at https://github.com/tshatrov/scriptfu/tree/gimp-2.10 
...
(define (script-fu-export-layers-plus-help)
  (let* ((elp-help-document (string-append gimp-directory "/" "scripts/export-layers-plus/Doc/export-layers-plus.html" ) ))
...
(script-fu-menu-register "script-fu-export-layers-plus-help" "<Image>/File/Export")